...
@Component({
  selector: 'app-past-graphs',
  templateUrl: './past-graphs.component.html',
  styleUrls: ['./past-graphs.component.css']
})


export class PastGraphsComponent implements OnInit {
...
public found :any;
public hours=["00:00", "00:30","01:00", "01:30","02:00", "02:30","03:00", "03:30","04:00", "04:30",
...
// startDate = new Date();
  ...
  constructor(private router:Router, private activatedRoute:ActivatedRoute, public service: HomeService,  public service2: CitylistService,public service3: InitialpredService, public http: HttpClient, public datepipe: DatePipe) 
  {
    ...
    this.service2.getCityList().subscribe(dropdownOptions => 
    {
      ...
      this.service.getBackendData(this.stname, this.selectedDate, this.fchr, this.isPast).subscribe(calledData => 
      {
  ...
  sendToBackend(selDate:any){
    this.service.getBackendData(this.stname, selDate, this.fchr, this.isPast).subscribe(calledData => 
      {
        this.catchCall= calledData
        this.found = 0
        this.getInitialPredicrions();
  ...
  myFunc(stName: string, plotHours:any,  plotActuals:any, plotPreds:any, plotErrors:any, RTF_VALUES:any, dateDisplay:any)
  {
    ...
    this.service3.getInitialPredictions().subscribe(initialPredictions => 
      {
                ...
                this.td_formatted = this.datepipe.transform(new Date(this.td), 'dd-MM-yyyy')
